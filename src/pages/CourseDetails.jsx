...
export default function CourseDetails() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setResponse(null); // Handle error gracefully
      }
    })();
  }, [courseId]);
  ...
  //   whatYouWillLearn: "No details available",
  //   createdAt: "Unknown",
  //   courseContent: [],
  //   instructor: "Unknown",
  //   studentsEnrolled: 0,
  ...
  console.log("response?.data?.data?.courseDetails" , response?.data?.courseDetails);
